...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
	...
	<a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
		...
		<div class="sidebar-brand-text mx-3">Ganaderia El Rosario</div>
	</a>
	...
	<li class="nav-item">
		...
		<i class="fa-thin fa-user-cowboy"></i>
			<span>Ganado</span>
		</a>
		<div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
			<div class="bg-white py-2 collapse-inner rounded">
				<a class="collapse-item" href="registro_producto.php">Nuevo Ganado</a>
				<a class="collapse-item" href="lista_productos.php">Ganado</a>
			</div>
		</div>
	</li>
