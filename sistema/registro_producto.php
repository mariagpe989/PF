   ...
   <div class="row">
     <div class="col-lg-6 m-auto">
       <form action="" method="post" autocomplete="off">
         ...
         <div class="form-group">
           <label for="producto">Ganado</label>
           <input type="text" placeholder="Ingrese el codigo" name="producto" id="producto" class="form-control">
         </div>
         <div class="form-group">
           <label for="precio">Precio/kilogramo</label>
